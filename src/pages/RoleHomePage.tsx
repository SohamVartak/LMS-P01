      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {showAdd && <div className="fixed inset-0 z-50 bg-slate-950/50 flex items-center justify-center p-4"><form onSubmit={publish} className="bg-white rounded-2xl w-full max-w-2xl p-6 shadow-2xl">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <label className="text-xs font-semibold">Category<select value={form.category} onChange={e=>setForm({...form,category:e.target.value})} className="mt-1 w-full border rounded-lg p-2.5 text-sm"><option>Computer Science</option><option>Computer Engineering</option><option>Artificial Intelligence</option><option>Software Engineering</option><option>Electrical Engineering</option><option>Electronics & Communication</option><option>Mechanical Engineering</option><option>Civil Engineering</option><option>Engineering Mathematics</option></select></label>
